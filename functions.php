<?php
function includeTemplate($fileName, $variables) {
   extract($variables);
   include($fileName);
}

function includeTemplate2($fileName, $variables) {
   $props = $variables;
   include($fileName);
}
...
//     [
//       'img'=>[
//         'desktop'=> 'dist/img/home_slider_1.png',
//         'mobile'=> 'dist/img/home_slider_1_m.png',
//       ],
//       'href'=> '###',
...
//     [
//       'img'=>[
//         'desktop'=> 'dist/img/news_slider_1.png',
//         'mobile'=> 'dist/img/news_slider_1_m.png',
//       ],
//       'href'=> '###',
//       'target'=> '', //a href target
//     ],
